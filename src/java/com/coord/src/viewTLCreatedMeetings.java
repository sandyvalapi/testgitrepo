 ...
 * @author svalapi
 */
public class viewTLCreatedMeetings extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            pst = con.prepareStatement("select * from user_calender where userid = ? and group_id is not null");
