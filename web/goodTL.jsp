                ...
                <div id="menu">
                    <ul>
                        <li class="first current_page_item">
                            <a href="/Coordinator/scheduleTLcalender.jsp">CALENDER</a></li>
                        <li class="first current_page_item">
                            <a href="/Coordinator/viewMyTeam.do?teamname=${sessionScope.teamname}">MY TEAM</a></li>
                         <li class="first current_page_item">
                            <a href="/Coordinator/scheduleMeeting.jsp">SCHEDULE</a></li>
                        <li class="first current_page_item">
